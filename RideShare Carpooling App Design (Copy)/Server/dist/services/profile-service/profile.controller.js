...
exports.addFriend = exports.getUserProfile = exports.createUserProfile = void 0;
...
const createUserProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const profile = yield profileService.createUserProfile(req.body);
...
const getUserProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const profile = yield profileService.getUserProfile(req.params.id);
        if (profile) {
            res.json(profile);
        }
        else {
...
const addFriend = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedUser = yield profileService.addFriend(userId, friendUniqueId);
        if (updatedUser) {
