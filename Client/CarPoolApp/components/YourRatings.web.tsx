  ...
  return (
    <ScrollView className="h-full w-full bg-gray-50 flex-1 pb-20">
      ...
      <View className="bg-white border-b p-4 flex flex-row items-center gap-3">
        ...
        <Text className="text-xl">Your Ratings</Text>
      </View>
      ...
      <View className="p-6 space-y-4">
        ...
        <View className="grid grid-cols-3 gap-3">
          {ratings.map((item) => (
            <View key={item.period} className="bg-white rounded-2xl p-4 items-center">
        ...
        {/* Stats */}
        <View className="bg-gradient-to-br from-blue-600 to-cyan-500 rounded-2xl p-5">
