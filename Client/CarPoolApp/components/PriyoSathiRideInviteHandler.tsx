      ...
      if (response.success && response.data) {
        ...
        if (!poolToUse) {
          poolToUse = {
            ...
            pickup_lat: pickupLocation?.latitude || inviteDetails.pickup.latitude,
            pickup_lng: pickupLocation?.longitude || inviteDetails.pickup.longitude,
            pickup_address: pickupLocation?.address || inviteDetails.pickup.address || null,
            pickup_h3_index: '',
