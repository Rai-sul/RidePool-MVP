...
export function EarningsScreen() {
  ...
  return (
    <SafeAreaView className="flex-1" style={{ backgroundColor: colors.background }} edges={['top', 'bottom']}>
      <View style={{ backgroundColor: colors.card, borderBottomWidth: 1, borderBottomColor: colors.border, paddingHorizontal: 16, height: 56, justifyContent: 'center' }}>
        <Text style={{ fontSize: 20, fontWeight: 'bold', color: colors.text }}>Earnings</Text>
      </View>
      <ScrollView 
        className="flex-1"
        refreshControl={
